...
TSharedRef<FPythonSlateDelegate> FUnrealEnginePythonHouseKeeper::NewStaticSlateDelegate(PyObject *PyCallable, FPythonSlateDelegate::Type InStatDelType, FName InContext)
{
	TSharedRef<FPythonSlateDelegate> Delegate = MakeShareable(new FPythonSlateDelegate());
	Delegate->SetPyCallable(PyCallable);
...
void FUnrealEnginePythonHouseKeeper::UntrackStaticSlateDelegate(FPythonSlateDelegate::Type InStaticDelType, FName InContext)
{
